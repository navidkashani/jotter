...
An English paragraph, on an English site: nothing should be marked here.

اینجا محلی هست برای نوشتن یادداشت‌های کوتاه به فارسی.
...
```ts
// یک نظر فارسی در ابتدای قطعه کد
